...
export default function ContractSign() {
    ...
    const [employerSignature, setEmployerSignature] =
        useState("");
    ...
    return (
        <>
            ...
            <Jumbotron
                title="근로계약 서명"
                content="근로계약 내용을 확인한 뒤 서명을 진행합니다"
            />
