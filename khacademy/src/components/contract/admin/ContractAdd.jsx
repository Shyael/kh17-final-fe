        ...
        useCallback(
            () => {
                ...
                if (
                    dailyWorkHours >= 8
                    &&
                    writtenBreakMinutes < 60
                ) {

                    toast.warning(
                        "1일 8시간 이상 근무 시 휴게시간은 60분 이상이어야 합니다"
                    );
                ...
                if (
                    ...
                    dailyWorkHours < 8
                    &&
                    writtenBreakMinutes < 30
                ) {

                    toast.warning(
                        "1일 4시간 이상 근무 시 휴게시간은 30분 이상이어야 합니다"
                    );
